  ...
  "modules": [
    {
      ...
      "sections": [
        {
          ...
          "visual": {
            ...
            "caption": "Risk management combines hazard recognition, stronger controls, permission and task-specific PPE."
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            "position": "65% 0",
            "alt": "Workshop safety controls including a guard, vice and eye protection",
            "caption": "A safe setup controls the machine, workpiece, work area and student before work begins."
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            "position": "65% 0",
            "alt": "Workshop safety warning and protected equipment",
            "caption": "Stop the task, make the area safe and report the changed condition or incident immediately."
          },
          "paragraphs": [
      ...
      "checks": [
        {
          "question": "Why are both likelihood and consequence considered?",
          "options": [
            "To decide how serious the risk is",
            "To choose the fastest tool",
            "To replace the demonstration",
            "To avoid all equipment"
          ],
          "answerIndex": 0,
          "explanation": "Risk level depends on both the chance of harm and how serious the possible harm could be.",
          "theoryIndex": 0
        },
        {
          "question": "What should happen if conditions change during practical work?",
          "options": [
            "Continue carefully",
            "Stop, make the area safe and seek teacher direction",
            "Rely only on PPE",
            "Ask another student to finish"
          ],
          "answerIndex": 1,
          "explanation": "Existing controls may no longer be effective when the work area, equipment, material or people nearby change.",
          "theoryIndex": 0
        }
      ],
    ...
    {
      "weeks": "3–4",
      "title": "Fishing Rod Holder brief, materials and planning",
      "summary": "Connect material properties to performance, then turn the Fishing Rod Holder brief and components drawing into a controlled production plan.",
      "sections": [
        {
          ...
          "visual": {
            ...
            "caption": "Select material and stock form to suit function, manufacture, environment and the approved brief."
          },
          "paragraphs": [
            ...
            "Choose material by matching properties to function, fabrication processes, corrosion exposure, availability and finish. A metal may perform well but still be unsuitable if it cannot be safely processed using the approved workshop equipment. Use the teacher-issued plan to identify the project-specific metal, then justify why its properties support the Fishing Rod Holder."
          ],
          "callout": "Link material properties to required performance and available processes."
        },
        {
          "title": "The Fishing Rod Holder brief and production context",
          "visual": {
            "position": "33.333% 0",
            "alt": "Balance showing function, time and available metal stock as linked Fishing Rod Holder constraints",
            "caption": "Connect the Fishing Rod Holder user, function, materials and constraints before production planning."
          },
          "paragraphs": [
            "The existing program identifies a Fishing Rod Holder, supported by the teacher-issued components drawing. The teacher-issued brief and plan define the exact requirements; this unit does not substitute its own geometry.",
            "Separate requirements from preferences. Record the user, function, environment, approved materials and processes, then identify which evidence will demonstrate that the finished Fishing Rod Holder meets the brief."
          ],
        ...
        },
        {
          ...
          "visual": {
            "position": "0 50%",
            "alt": "Several fabricated sheet-metal concepts developed from sketches",
            "caption": "Develop alternatives, compare them against the brief and plan the approved production sequence."
          },
          "paragraphs": [
        ...
        {
          "title": "Read the Fishing Rod Holder components drawing",
          "visual": {
            "plan": {
              "pdf": "../assets/plans/year9-metal-fishing-rod-holder-components-plan.pdf",
              "preview": "../assets/plans/year9-metal-fishing-rod-holder-components-plan.png",
              "alt": "Teacher-issued Fishing Rod Holder components drawing showing the rod-holder tube, stake and rotation tab in multiple views with dimensions and notes.",
              "caption": "Teacher-issued Fishing Rod Holder components drawing for the rod holder, stake and rotation tab. The drawing, teacher demonstrations and current workshop instructions control all exact details."
            }
          },
          "paragraphs": [
            "Begin by orienting the sheet so the title block and drawing title, “FISHING ROD HOLDER: COMPONENTS”, can be read normally. Scan the whole page before focusing on individual details. Identify the three named parts: ROD HOLDER, STAKE and ROTATION TAB. Then match each name to its related view or views by following the labels, shapes, dimensions and notes shown on the sheet. Because the drawing contains multiple views, do not assume two nearby shapes are separate parts until you have checked their labels and how the views relate.",
            "Read the printed information for each component carefully. The ROD HOLDER is labelled 50 nb. pipe, 1 off; the STAKE is labelled Ø12 black bar, 1 off; and the ROTATION TAB is labelled 25 x 5 flat, 1 off. Check both the material label and the quantity because they help define what belongs in the project. The sheet is marked NOT TO SCALE, so never measure the page to work out a size. Use only the printed dimensions and written notes, and ask the teacher about anything unclear, missing or apparently conflicting.",
            "Before Module 3 marking and production, turn your plan reading into evidence. Save a checked cutting list, an annotated copy of the plan or a clear folio note showing that you identified each component, checked its quantity and material label, and traced the relevant dimensions and notes. Do not begin marking or production from memory or guesswork. The teacher-issued plan, demonstrations and instructions control the exact dimensions, materials, machine settings, construction sequence and permissions, so any uncertainty must be resolved before work continues."
          ],
          "callout": "Read, match, check and record before you mark."
        }
      ],
      "checks": [
        {
          "question": "Which statement correctly distinguishes property from performance?",
          "options": [
            "A property is a metal characteristic; performance is how it behaves in use",
            "A property is cost; performance is colour",
            "A property is the product; performance is the plan",
            "They always mean the same thing"
          ],
          "answerIndex": 0,
          "explanation": "Properties describe characteristics while performance describes how effectively the metal works in context.",
          "theoryIndex": 0
        },
        {
          ...
          "options": [
            ...
            "Its properties suit function, fabrication, corrosion, availability and finish",
            "Ferrous is always best"
          ],
          "answerIndex": 2,
          "explanation": "A sound justification connects relevant properties to the full project context.",
          "theoryIndex": 0
        },
        {
          "question": "What is the title printed on the component drawing?",
          "options": [
            "FISHING ROD HOLDER: COMPONENTS",
            "FISHING ROD HOLDER: ASSEMBLY",
            "ROD HOLDER DEVELOPMENT",
            "FISHING STAKE COMPONENTS"
          ],
          "answerIndex": 0,
          "explanation": "The verified drawing title identifies the sheet as the component drawing for the Fishing Rod Holder.",
          "theoryIndex": 3
        },
        {
          "question": "Which three named parts must be located on the sheet?",
          "options": [
            "Pipe, bracket and handle",
            "Rod holder, stake and rotation tab",
            "Stake, base and pivot",
            "Rod holder, clamp and support"
          ],
          "answerIndex": 1,
          "explanation": "The drawing names the ROD HOLDER, STAKE and ROTATION TAB as the three project components.",
          "theoryIndex": 3
        },
        {
          "question": "How should a student determine a component’s required size?",
          "options": [
            "Measure the printed view",
            "Estimate from nearby parts",
            "Use the printed dimensions and notes",
            "Copy a similar classroom project"
          ],
          "answerIndex": 2,
          "explanation": "The sheet is not to scale, so only its printed dimensions and notes provide valid drawing information.",
          "theoryIndex": 3
        },
        {
          "question": "What does “1 off” indicate beside a component label?",
          "options": [
            "One view is provided",
            "One component is required",
            "One dimension is missing",
            "One material may be substituted"
          ],
          "answerIndex": 1,
          "explanation": "The quantity label shows that one of the named components is required for the project.",
          "theoryIndex": 3
        },
        {
          "question": "Which material label belongs to the STAKE?",
          "options": [
            "25 x 5 flat",
            "50 nb. pipe",
            "Ø12 black bar",
            "Unlabelled sheet metal"
          ],
          "answerIndex": 2,
          "explanation": "The verified component information identifies the STAKE as Ø12 black bar, with one required.",
          "theoryIndex": 3
        },
        {
          "question": "What should be checked when matching a name to several drawing views?",
          "options": [
            "Labels, shapes, dimensions and notes",
            "The apparent printed size only",
            "The darkest lines on the page",
            "The order in which views appear"
          ],
          "answerIndex": 0,
          "explanation": "Several forms of printed information should be traced together before deciding which views represent each part.",
          "theoryIndex": 3
        },
        {
          "question": "Which label belongs to the ROTATION TAB?",
          "options": [
            "Ø12 black bar, 1 off",
            "50 nb. pipe, 1 off",
            "25 x 5 flat, 1 off",
          ...
          "answerIndex": 2,
          "explanation": "The drawing identifies the ROTATION TAB as 25 x 5 flat and specifies a quantity of one.",
          "theoryIndex": 3
        },
        {
          "question": "What should happen when drawing information appears unclear or conflicting?",
          "options": [
            "Choose the most likely interpretation",
            "Continue and correct it later",
            "Ask another student to decide",
            "Check with the teacher before continuing"
          ],
          "answerIndex": 3,
          "explanation": "Uncertainty must be resolved through the teacher because the issued information controls the authorised project requirements.",
          "theoryIndex": 3
        },
        {
          "question": "Which item would provide suitable evidence before Module 3?",
          "options": [
            "A memorised list of component names",
            "An unchecked rough sketch",
            "A checked cutting list, annotated plan or folio note",
            "A photograph of unrelated workshop equipment"
          ],
          "answerIndex": 2,
          "explanation": "Saved evidence should show that component identities, quantities, material labels, dimensions and notes were checked.",
          "theoryIndex": 3
        },
        {
          "question": "Who controls the exact machine settings and construction sequence?",
          "options": [
            "The student’s previous experience",
            "The teacher-issued demonstrations and instructions",
            "The apparent shape of each component",
            "The printed scale of the drawing"
          ],
          "answerIndex": 1,
          "explanation": "Teacher-issued plans, demonstrations and instructions control settings, sequence, materials, dimensions and permissions.",
          "theoryIndex": 3
        }
      ],
    ...
    },
    {
      ...
      "sections": [
        {
          ...
          "visual": {
            "position": "33.333% 50%",
            "alt": "Checked working drawing with steel rule, square and approval mark",
            "caption": "Accurate work begins with the controlling drawing, a reliable datum and a pre-cut check."
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            ...
            "photos": [
              {
                "src": "../guided/images/metal-tools/jenny-calipers.jpg",
                "alt": "Two Jenny callipers with one straight leg and one inward-pointing marking leg",
                "caption": "Jenny callipers are also called odd-leg callipers. Photo: Glenn McKechnie, CC BY-SA 3.0."
              },
              {
                "src": "../guided/images/metal-tools/scribers.jpg",
                "alt": "Assortment of straight and bent metalworking scribes with pointed steel tips",
                "caption": "Scribes have sharp hardened points; use the type demonstrated for the task. Photo: Glenn McKechnie, CC BY-SA 3.0."
              },
              {
                "src": "../guided/images/metal-tools/centre-punch.jpg",
                "alt": "Steel centre punch with a knurled body and pointed end",
                "caption": "One centre-punch example; the teacher selects the suitable type and size. Photo: Luke Milburn, CC BY 2.0."
              }
            ]
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            ...
            "photos": [
              {
                "src": "../guided/images/metal-tools/tin-snips.jpg",
                "alt": "Pair of hand-operated tin snips with two cutting blades and loop handles",
                "caption": "Tin snips are selected to suit the demonstrated cut and material. Photo: Zkabirkhan, CC0 1.0."
              },
              {
                "src": "../guided/images/metal-tools/manual-nibbler.jpg",
                "alt": "Manual sheet-metal nibbler with two handles and a compact cutting head",
                "caption": "A manual nibbler removes small pieces of sheet; the image is for recognition, not an operating sequence. Photo: Richard Frantz Jr, public domain."
              },
              {
                "src": "../guided/images/metal-tools/bossing-mallet.png",
                "alt": "Wooden bossing mallet with a smooth rounded pear-shaped head",
                "caption": "The rounded head identifies a bossing mallet. Teacher demonstrations control the actual forming setup. AI-generated identification reference."
              }
            ]
          },
          "paragraphs": [
      ...
      "checks": [
        {
          "question": "What is the main purpose of a datum edge?",
          "options": [
            "Provide one reliable reference for marking",
            "Show where to apply force",
            "Replace the plans",
            "Identify finish colour"
          ],
          "answerIndex": 0,
          "explanation": "A datum gives measurements a consistent starting point and reduces accumulated errors.",
          "theoryIndex": 0
        },
        {
          "question": "What should happen before cutting or forming?",
          "options": [
            "Secure the work and recheck markings",
            "Remove waste marks",
            "Force material into position",
            "Change sequence without approval"
          ],
          "answerIndex": 0,
          "explanation": "Securing the work and checking datum, orientation, waste side and sequence support safe, accurate processing.",
          "theoryIndex": 0
        }
      ],
    ...
    },
    {
      ...
      "sections": [
        {
          ...
          "visual": {
            ...
            "caption": "The approved joint must suit the load, materials, access, finish and classroom process."
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            ...
            "photos": [
              {
                "src": "../guided/images/metal-tools/angle-grinder.jpg",
                "alt": "Angle grinder at rest with its side handle and wheel guard fitted",
                "caption": "An angle grinder requires specific permission, the correct guarded setup and task-directed PPE. Photo: soulfish, CC BY-SA 2.0."
              },
              {
                "src": "../guided/images/metal-tools/stationary-metal-cutoff-saw.png",
                "alt": "Stationary pedestal metal cut-off saw at rest with a guarded circular wheel and built-in vice",
                "caption": "A guarded stationary metal cut-off saw. The image identifies the machine family; it does not replace the workshop SOP or demonstration. AI-generated identification reference."
              }
            ]
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            ...
            "caption": "Remove faults and contamination before applying the approved protective finish."
          },
          "paragraphs": [
      ...
      "checks": [
        {
          "question": "Which factors should guide a joining method?",
          "options": [
            "Load, permanence, access, heat, appearance and corrosion",
            "Only colour",
            "Whichever is fastest",
            "Another student’s choice"
          ],
          "answerIndex": 0,
          "explanation": "A suitable joint must match functional, manufacturing and environmental needs.",
          "theoryIndex": 0
        },
        {
          "question": "Why trial fit before permanent joining?",
          "options": [
            "Check fit and alignment before errors are locked in",
            "Avoid the plans",
            "Make metal harder",
            "Replace the approved process"
          ],
          "answerIndex": 0,
          "explanation": "A trial fit reveals contact, alignment and position problems while they can still be corrected.",
          "theoryIndex": 0
        }
      ],
    ...
    },
    {
      ...
      "sections": [
        {
          ...
          "visual": {
            "position": "65% 100%",
            "alt": "Fabricated metal project with inspection and improvement symbols",
            "caption": "Use measured checks and functional evidence to judge quality and direct improvement."
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            ...
            "caption": "Compare how current and emerging processes affect precision, repeatability, safety and waste."
          },
          "paragraphs": [
        ...
        },
        {
          ...
          "visual": {
            "position": "100% 100%",
            "alt": "Organised project notes, photograph, checklist and improvement arrow",
            "caption": "Present a concise evidence chain and evaluate the result against the approved criteria."
          },
          "paragraphs": [
            "Organise evidence from the Fishing Rod Holder project so the reader can follow the brief, research, planning, production, quality checks, problem solving and evaluation. Captions should explain what the evidence proves, not merely identify the photograph.",
      ...
      "checks": [
        {
          "question": "How should conventional and CNC processes be compared?",
          "options": [
            "By which looks advanced",
            "By suitability for the task and result",
            "Choose CNC every time",
            "Avoid conventional skills"
          ],
          "answerIndex": 1,
          "explanation": "Suitability depends on accuracy, quantity, material, resources and purpose.",
          "theoryIndex": 0
        },
        {
          "question": "Which is the strongest evaluation?",
          "options": [
            "It was good",
            "Everything worked",
            "The trial fit showed misalignment, so I rechecked it; next time I would check earlier",
            "I would make it better"
          ],
          "answerIndex": 2,
          "explanation": "A strong evaluation names evidence, explains the result and identifies a realistic improvement.",
          "theoryIndex": 2
        }
      ],
