(function () {
  ...
  nav.setAttribute("aria-label", "Fishing Rod Holder course navigation");
  ...
  brand.innerHTML = '<span class="course-family-nav__mark" aria-hidden="true">RH</span><span>Fishing Rod Holder</span>';
