  ...
  modules: [
    ...
    },
    {
      ...
      checks: [
        ...
        { question: "What should a student use first to orient the drawing correctly?", options: ["The largest component view", "The position of the dimensions", "The drawing title and upright views", "The order of workshop tools"], answerIndex: 2, explanation: "The title should read normally and the views should be upright before the drawing is interpreted.", theoryIndex: 3 },
        { question: "Which title appears on the teacher-issued drawing?", options: ["TOOL CARRYALL DEVELOPMENT", "Sheet-metal Toolbox Plan", "Year 9 Metal Toolbox", "Toolbox Assembly Drawing"], answerIndex: 0, explanation: "The verified title printed on the teacher-issued drawing is “TOOL CARRYALL DEVELOPMENT”.", theoryIndex: 3 },
        { question: "How should the website and drawing names be treated?", options: ["As two unrelated projects", "As interchangeable drawing titles", "As student-selected alternatives", "As different names for the matching project context"], answerIndex: 3, explanation: "The website uses “Sheet-metal Toolbox”, while the drawing retains its printed title.", theoryIndex: 3 },
        { question: "Which named parts must be located on the drawing?", options: ["Base, lid and bracket", "HANDLE, BODY and SIDE x 2", "Front, back and tray", "Handle, hinge and panel"], answerIndex: 1, explanation: "The verified component labels are HANDLE, BODY and SIDE x 2.", theoryIndex: 3 },
        { question: "What is the best way to identify which view belongs to a component?", options: ["Choose the simplest shape", "Use the printed component label", "Select the view with most dimensions", "Match it by estimated size"], answerIndex: 1, explanation: "Printed names and visible view information provide stronger evidence than assumptions about shape or size.", theoryIndex: 3 },
        { question: "How should dimension information be traced?", options: ["From arrows and extension lines to the controlled feature", "From the page edge towards the centre", "From the largest value to the smallest", "From the handle view to every other part"], answerIndex: 0, explanation: "Dimension arrows and extension lines connect each value to the feature it controls.", theoryIndex: 3 },
        { question: "What should be distinguished from the outside shape of a part?", options: ["The drawing title", "The component label", "The page border", "Fold or edge lines"], answerIndex: 3, explanation: "Fold and edge lines carry different information from the component’s outside shape.", theoryIndex: 3 },
        { question: "What should a student do when drawing information is unclear?", options: ["Estimate from the component shape", "Copy a value from another view", "Record the uncertainty for teacher checking", "Leave the feature unmarked without comment"], answerIndex: 2, explanation: "Unclear information should be recorded and checked rather than guessed or silently ignored.", theoryIndex: 3 },
        { question: "Which information remains controlled by teacher-issued plans, demonstrations and instructions?", options: ["Only the project name", "Only the folio format", "Exact dimensions, materials, settings, sequence and permissions", "Only the number of side pieces"], answerIndex: 2, explanation: "These project details and permissions must come from the authorised teacher sources.", theoryIndex: 3 },
        { question: "What evidence should be saved before Module 3 marking out?", options: ["A checked plan annotation or folio note", "A completed cutting record", "A photograph of finished assembly", "A list of generic workshop rules"], answerIndex: 0, explanation: "The saved annotation or folio note shows that the plan was read and verified before marking out.", theoryIndex: 3 },
        { question: "What is the title printed on the component drawing?", options: ["FISHING ROD HOLDER: COMPONENTS", "FISHING ROD HOLDER: ASSEMBLY", "ROD HOLDER DEVELOPMENT", "FISHING STAKE COMPONENTS"], answerIndex: 0, explanation: "The verified drawing title identifies the sheet as the component drawing for the Fishing Rod Holder.", theoryIndex: 4 },
        { question: "Which three named parts must be located on the sheet?", options: ["Pipe, bracket and handle", "Rod holder, stake and rotation tab", "Stake, base and pivot", "Rod holder, clamp and support"], answerIndex: 1, explanation: "The drawing names the ROD HOLDER, STAKE and ROTATION TAB as the three project components.", theoryIndex: 4 },
        { question: "How should a student determine a component’s required size?", options: ["Measure the printed view", "Estimate from nearby parts", "Use the printed dimensions and notes", "Copy a similar classroom project"], answerIndex: 2, explanation: "The sheet is not to scale, so only its printed dimensions and notes provide valid drawing information.", theoryIndex: 4 },
        { question: "What does “1 off” indicate beside a component label?", options: ["One view is provided", "One component is required", "One dimension is missing", "One material may be substituted"], answerIndex: 1, explanation: "The quantity label shows that one of the named components is required for the project.", theoryIndex: 4 },
        { question: "Which material label belongs to the STAKE?", options: ["25 x 5 flat", "50 nb. pipe", "Ø12 black bar", "Unlabelled sheet metal"], answerIndex: 2, explanation: "The verified component information identifies the STAKE as Ø12 black bar, with one required.", theoryIndex: 4 },
        { question: "What should be checked when matching a name to several drawing views?", options: ["Labels, shapes, dimensions and notes", "The apparent printed size only", "The darkest lines on the page", "The order in which views appear"], answerIndex: 0, explanation: "Several forms of printed information should be traced together before deciding which views represent each part.", theoryIndex: 4 },
        { question: "Which label belongs to the ROTATION TAB?", options: ["Ø12 black bar, 1 off", "50 nb. pipe, 1 off", "25 x 5 flat, 1 off", "25 nb. pipe, 2 off"], answerIndex: 2, explanation: "The drawing identifies the ROTATION TAB as 25 x 5 flat and specifies a quantity of one.", theoryIndex: 4 },
        { question: "What should happen when drawing information appears unclear or conflicting?", options: ["Choose the most likely interpretation", "Continue and correct it later", "Ask another student to decide", "Check with the teacher before continuing"], answerIndex: 3, explanation: "Uncertainty must be resolved through the teacher because the issued information controls the authorised project requirements.", theoryIndex: 4 },
        { question: "Which item would provide suitable evidence before Module 3?", options: ["A memorised list of component names", "An unchecked rough sketch", "A checked cutting list, annotated plan or folio note", "A photograph of unrelated workshop equipment"], answerIndex: 2, explanation: "Saved evidence should show that component identities, quantities, material labels, dimensions and notes were checked.", theoryIndex: 4 },
        { question: "Who controls the exact machine settings and construction sequence?", options: ["The student’s previous experience", "The teacher-issued demonstrations and instructions", "The apparent shape of each component", "The printed scale of the drawing"], answerIndex: 1, explanation: "Teacher-issued plans, demonstrations and instructions control settings, sequence, materials, dimensions and permissions.", theoryIndex: 4 }
      ],
