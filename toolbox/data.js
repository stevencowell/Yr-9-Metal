window.COURSE_DATA = {
  "shortTitle": "Sheet-metal Toolbox",
  "presentationStem": "sheet-metal-toolbox",
  "storagePrefix": "yr9-toolbox-guided",
  "modules": [
    {
      "weeks": "1–2",
    ...
    {
      "weeks": "3–4",
      "title": "Toolbox brief, materials and planning",
      "summary": "Connect material properties to performance, then read the Tool Carryall drawing and turn the approved Toolbox brief into a controlled production plan.",
      "sections": [
        {
        ...
        },
        {
          ...
          "paragraphs": [
            "Start by placing the teacher-issued A4 drawing so the title, “TOOL CARRYALL DEVELOPMENT”, reads normally and the views are upright. The website calls the matching project context “Sheet-metal Toolbox”; this is the website name, while the drawing title remains the source name. Scan the whole page before focusing on details. Locate the labels HANDLE, BODY and SIDE x 2, then match each label to the view that shows that part. Do not assume that the largest or simplest shape is a particular component; use the printed names and visible view information.",
            "Next, trace the information for one part at a time. Begin with the BODY, then repeat the process for the HANDLE and the two SIDE pieces. Follow each dimension from its extension lines and arrows to the feature it controls. Identify the fold or edge lines shown in the view and distinguish them from the outside shape of the part. Check that you can explain which dimensions, lines and notes belong to each named component. Record anything that is unclear, incomplete or easy to confuse rather than filling gaps from memory or guessing.",
            "Before any marking or cutting, take the plan and your questions to the teacher. Confirm any uncertain dimension, fold or edge line, part orientation, repeated side requirement, or relationship between views. Exact dimensions, materials, machine settings, construction sequence and permissions come only from the teacher-issued plan, demonstrations and instructions. After the plan has been checked, save an annotated copy or a clear folio note showing what you identified and what the teacher confirmed. This becomes evidence that you read and verified the plan before Module 3 marking out."
          ],
          "callout": "Check the plan first; mark out only from confirmed information."
        }
      ],
      "checks": [
        {
        ...
        {
          "question": "What should a student use first to orient the drawing correctly?",
          "options": [
            "The largest component view",
            "The position of the dimensions",
            "The drawing title and upright views",
            "The order of workshop tools"
          ],
          "answerIndex": 2,
          "explanation": "The title should read normally and the views should be upright before the drawing is interpreted.",
          "theoryIndex": 3
        },
        {
          "question": "Which title appears on the teacher-issued drawing?",
          "options": [
            "TOOL CARRYALL DEVELOPMENT",
            "Sheet-metal Toolbox Plan",
            "Year 9 Metal Toolbox",
            "Toolbox Assembly Drawing"
          ],
          "answerIndex": 0,
          "explanation": "The verified title printed on the teacher-issued drawing is “TOOL CARRYALL DEVELOPMENT”.",
          "theoryIndex": 3
        },
        {
          "question": "How should the website and drawing names be treated?",
          "options": [
            "As two unrelated projects",
            "As interchangeable drawing titles",
            "As student-selected alternatives",
            "As different names for the matching project context"
          ],
          "answerIndex": 3,
          "explanation": "The website uses “Sheet-metal Toolbox”, while the drawing retains its printed title.",
          "theoryIndex": 3
        },
        {
          "question": "Which named parts must be located on the drawing?",
          "options": [
            "Base, lid and bracket",
            "HANDLE, BODY and SIDE x 2",
            "Front, back and tray",
            "Handle, hinge and panel"
          ],
          "answerIndex": 1,
          "explanation": "The verified component labels are HANDLE, BODY and SIDE x 2.",
          "theoryIndex": 3
        },
        {
          "question": "What is the best way to identify which view belongs to a component?",
          "options": [
            "Choose the simplest shape",
            "Use the printed component label",
            "Select the view with most dimensions",
            "Match it by estimated size"
          ],
          "answerIndex": 1,
          "explanation": "Printed names and visible view information provide stronger evidence than assumptions about shape or size.",
          "theoryIndex": 3
        },
        {
          "question": "How should dimension information be traced?",
          "options": [
            "From arrows and extension lines to the controlled feature",
            "From the page edge towards the centre",
            "From the largest value to the smallest",
            "From the handle view to every other part"
          ],
          "answerIndex": 0,
          "explanation": "Dimension arrows and extension lines connect each value to the feature it controls.",
          "theoryIndex": 3
        },
        {
          "question": "What should be distinguished from the outside shape of a part?",
          "options": [
            "The drawing title",
            "The component label",
            "The page border",
          ...
          "answerIndex": 3,
          "explanation": "Fold and edge lines carry different information from the component’s outside shape.",
          "theoryIndex": 3
        },
        {
          "question": "What should a student do when drawing information is unclear?",
          "options": [
            "Estimate from the component shape",
            "Copy a value from another view",
            "Record the uncertainty for teacher checking",
            "Leave the feature unmarked without comment"
          ],
          "answerIndex": 2,
          "explanation": "Unclear information should be recorded and checked rather than guessed or silently ignored.",
          "theoryIndex": 3
        },
        {
          "question": "Which information remains controlled by teacher-issued plans, demonstrations and instructions?",
          "options": [
            "Only the project name",
            "Only the folio format",
            "Exact dimensions, materials, settings, sequence and permissions",
            "Only the number of side pieces"
          ],
          "answerIndex": 2,
          "explanation": "These project details and permissions must come from the authorised teacher sources.",
          "theoryIndex": 3
        },
        {
          "question": "What evidence should be saved before Module 3 marking out?",
          "options": [
            "A checked plan annotation or folio note",
            "A completed cutting record",
            "A photograph of finished assembly",
            "A list of generic workshop rules"
          ],
          "answerIndex": 0,
          "explanation": "The saved annotation or folio note shows that the plan was read and verified before marking out.",
          "theoryIndex": 3
        }
      ],
    ...
    },
    {
      ...
      "sections": [
        ...
        },
        {
          ...
          "paragraphs": [
            "Organise evidence from the Toolbox project so the reader can follow the brief, research, planning, production, quality checks, problem solving and evaluation. Captions should explain what the evidence proves, not merely identify the photograph.",
